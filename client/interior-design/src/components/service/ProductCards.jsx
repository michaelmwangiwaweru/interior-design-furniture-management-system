// ProductCards.jsx (updated with Checkout button + category sidebar)
      ...
      <Row>
        ...
        <Col md={3}>
          ...
          <ul className="list-unstyled">
            <li>
              <button
                className={`btn btn-link p-0 mb-1 ${!filterCategory ? "fw-bold" : ""}`}
              ...
              <li key={idx}>
                <button
                  className={`btn btn-link p-0 mb-1 ${
                    filterCategory === cat ? "fw-bold text-success" : ""
                  }`}
        ...
        <Col md={9}>
            ...
            {currentProducts.map((product) => (
              ...
              >
                <Card className="h-100 shadow-sm border-0 rounded overflow-hidden product-card">
                  <div
                    style={{ overflow: "hidden", height: "350px", cursor: "zoom-in" }}
                  ...
                  <Card.Body className="d-flex flex-column">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                      ...
                      <Card.Subtitle className="text-primary fw-bold mb-0">
          ...
          {/* Styles unchanged */}
          <style>{`
            .btn-product { background-color: #78716C; color: white; border-radius: 4px; transition: background-color 0.3s; }
            .btn-product:hover { background-color: #6D28D9 ; color: white; }
            .btn-product-outline { border-radius: 4px; transition: background-color 0.3s, color 0.3s; }
            .btn-product-outline:hover { background-color: #c91894; color: white; }
